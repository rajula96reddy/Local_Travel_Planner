...
class FaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fare" do
    assert_difference('Fare.count') do
      post fares_url, params: { fare: { Ending_Range: @fare.Ending_Range, Price: @fare.Price, Starting_Range: @fare.Starting_Range } }
    end
  ...
  test "should update fare" do
    patch fare_url(@fare), params: { fare: { Ending_Range: @fare.Ending_Range, Price: @fare.Price, Starting_Range: @fare.Starting_Range } }
