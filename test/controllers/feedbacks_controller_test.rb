...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { Feedback: @feedback.Feedback, Reply: @feedback.Reply, Userid: @feedback.Userid } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { Feedback: @feedback.Feedback, Reply: @feedback.Reply, Userid: @feedback.Userid } }
